...
class Category extends Model
{
    ...
    {
        $sql = "INSERT INTO ads (title, text,id_user,id_categories,region,price,img,img_other,img_other2) VALUES ('{$title}','{$text}','{$id_user}','{$id_categories}','{$this->getRegion($region)[0]['region']}','{$price}','{$img}','{$img_other}','{$img_other2}')";
