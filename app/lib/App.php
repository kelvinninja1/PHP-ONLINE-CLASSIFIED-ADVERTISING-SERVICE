...
/*        switch ($controller_class) {
            case "CategoriesController":
                $controller_object = new CategoriesController();
                break;
            case "AboutController":
                $controller_object = new AboutController();
                break;
            case "ContactsController":
                $controller_object = new ContactsController();
                break;
            case "MessagesController":
                $controller_object = new MessagesController();
                break;
